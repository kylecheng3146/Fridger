...
class UserRepositoryTest {
    ...
    @Test
    fun `findOrCreateUserByGoogle should create new user if not exists`() = runTest {
    ...
    @Test
    fun `findOrCreateUserByGoogle should find existing user by googleId`() = runTest {
        // First, create a user
        val profile = GoogleProfile("google123", "test@example.com", "Test User", null)
    ...
    @Test
    fun `findOrCreateUserByGoogle should find existing user by email and update googleId`() = runTest {
